...
class splunk_for_vmware_setup(controllers.BaseController):
	...
	def save_collection(self, *args, **kwargs):
		...
		for key in collection_metric_list.keys():
	...
	def get_collection(self, *args, **kwargs):
		...
		entity_mbwl_list = ["vm_metric_whitelist", "vm_metric_blacklist", "host_metric_whitelist", "host_metric_blacklist", "cluster_metric_whitelist", "cluster_metric_blacklist", "rp_metric_whitelist", "rp_metric_blacklist"]
		...
		try:
			for entity_mbwl in entity_mbwl_list:
				mbwl_list = getattr(default_stanza, entity_mbwl, [""])
				mbwl = ', '.join(mbwl_list)
				collection_metric_dict[entity_mbwl] = mbwl
